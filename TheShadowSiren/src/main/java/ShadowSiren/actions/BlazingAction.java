...
public class BlazingAction extends AbstractGameAction {
    ...
    public BlazingAction(AbstractCreature target, DamageInfo info) {
        this.info = info;
        ...
        if (this.shouldCancelAction()) {
            ...
            if (this.isDone) {
                ...
                if (this.target.lastDamageTaken > 0) {
                    ...
                    this.addToTop(new ApplyPowerAction(this.target, this.info.owner, new BurnPower(this.target, this.info.owner, this.target.lastDamageTaken)));
