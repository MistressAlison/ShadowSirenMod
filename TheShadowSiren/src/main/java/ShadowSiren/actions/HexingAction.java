...
public class HexingAction extends AbstractGameAction {
    private final DamageInfo info;

    public HexingAction(AbstractCreature target, DamageInfo info) {
        this.info = info;
        ...
        if (this.shouldCancelAction()) {
            ...
            if (this.isDone) {
                ...
                if (this.target.lastDamageTaken > 0) {
                    ...
                    this.addToTop(new ApplyPowerAction(this.target, this.info.owner, new HexingPower(this.target, this.info.owner, this.target.lastDamageTaken)));
