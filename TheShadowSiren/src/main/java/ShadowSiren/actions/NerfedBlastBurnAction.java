...
public class NerfedBlastBurnAction extends AbstractGameAction {
    public final int[] damages;

    public NerfedBlastBurnAction(AbstractCreature source, int[] damages, DamageInfo.DamageType type) {
        this.source = source;
