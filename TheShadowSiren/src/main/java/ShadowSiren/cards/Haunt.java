...
public class Haunt extends AbstractShadowCard {

    // TEXT DECLARATION

    public static final String ID = ShadowSirenMod.makeID(Haunt.class.getSimpleName());
    public static final String IMG = makeCardPath("Haunt.png");
