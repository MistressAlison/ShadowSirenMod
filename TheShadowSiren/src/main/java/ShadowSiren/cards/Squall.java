...
public class Squall extends AbstractSmokeCard {

    // TEXT DECLARATION

    public static final String ID = ShadowSirenMod.makeID(Squall.class.getSimpleName());
    ...
    //TODO merge into a prismatic power
    public Squall() {
