...
public class ShadowFistDual extends AbstractShadowCard implements FistAttack, UniqueCard {

    // TEXT DECLARATION

    public static final String ID = ShadowSirenMod.makeID(ShadowFistDual.class.getSimpleName());
