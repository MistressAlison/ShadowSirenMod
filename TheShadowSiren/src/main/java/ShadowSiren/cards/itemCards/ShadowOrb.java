...
public class ShadowOrb extends AbstractItemCard {
    ...
    public void onPlayCard(AbstractCard c, AbstractMonster m) {
        if (isActive && c != this) {
            this.addToBot(DamageModifierHelper.makeModifiedDamageAllEnemiesAction(this, AbstractDungeon.player, multiDamage, DamageInfo.DamageType.THORNS, AbstractGameAction.AttackEffect.NONE, true));
            this.superFlash();
            this.applyEffect();
        }
    }
