...
public class StanceDanceAbyss extends AbstractPrismaticAbyssCard implements UniqueCard {

    // TEXT DECLARATION

    public static final String ID = ShadowSirenMod.makeID(StanceDanceAbyss.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (secondMagicNumber > 0) {
            this.addToBot(new ApplyPowerAction(m, p, new DrenchPower(m, magicNumber*secondMagicNumber)));
        }
    }
