...
public abstract class AbstractPrismaticAbyssCard extends AbstractPrismaticCard {
    ...
    public List<TooltipInfo> getCustomTooltipsTop() {
        if (prismTooltip == null)
        {
            ...
            prismTooltip.add(new TooltipInfo(BaseMod.getKeywordTitle("shadowsiren:prismatic_abyss"), BaseMod.getKeywordDescription("shadowsiren:prismatic_abyss")));
        }
