...
public abstract class AbstractPrismaticSmokeCard extends AbstractPrismaticCard {
    ...
    public List<TooltipInfo> getCustomTooltipsTop() {
        if (prismTooltip == null)
        {
            ...
            prismTooltip.add(new TooltipInfo(BaseMod.getKeywordTitle("shadowsiren:prismatic_smoke"), BaseMod.getKeywordDescription("shadowsiren:prismatic_smoke")));
        }
