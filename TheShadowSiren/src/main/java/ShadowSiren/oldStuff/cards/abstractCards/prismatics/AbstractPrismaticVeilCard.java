...
public abstract class AbstractPrismaticVeilCard extends AbstractPrismaticCard {
    ...
    public List<TooltipInfo> getCustomTooltipsTop() {
        if (prismTooltip == null)
        {
            ...
            prismTooltip.add(new TooltipInfo(BaseMod.getKeywordTitle("shadowsiren:prismatic_veil"), BaseMod.getKeywordDescription("shadowsiren:prismatic_veil")));
        }
