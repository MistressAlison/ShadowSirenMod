...
public class NextTurnVigorPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = ShadowSirenMod.makeID("NextTurnVigorPower");
    ...
    public NextTurnVigorPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
    ...
    public AbstractPower makeCopy() {
        return new NextTurnVigorPower(owner, amount);
    }
