...
public class ElectricPotion extends CustomPotion {


    public static final String POTION_ID = ShadowSirenMod.makeID("ElectricPotion");
    ...
    public void initializeData() {
        ...
        tips.add(new PowerTip(
                BaseMod.getKeywordTitle("shadowsiren:electric"),
                BaseMod.getKeywordDescription("shadowsiren:electric")
        ));
    }
