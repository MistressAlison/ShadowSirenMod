...
public class PiezoCapacitorPower extends AbstractPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = ShadowSirenMod.makeID("PiezoCapacitorPower");
    ...
    public PiezoCapacitorPower(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
    ...
    public AbstractPower makeCopy() {
        return new PiezoCapacitorPower(owner, amount);
    }
}
