...
public class ColouredWaterSplashParticleEffect extends AbstractGameEffect {
    ...
    public ColouredWaterSplashParticleEffect(float x, float y, Color color) {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.img, this.x, this.y, (float)this.img.packedWidth / 2.0F, (float)this.img.packedHeight / 2.0F, (float)this.img.packedWidth, (float)this.img.packedHeight, this.scale, this.scale * 0.54F, this.rotation);
    }
