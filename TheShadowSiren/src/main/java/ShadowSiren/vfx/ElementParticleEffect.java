...
public class ElementParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float oX;
    private float oY;
    ...
    private final Color fireColor = new Color(MathUtils.random(0.8F, 1.0F), 0.4F, 0.4F, 0.0F);
    private final Color iceColor = new Color(0.6F, 0.7F, MathUtils.random(0.8F, 1.0F), 0.0F);
    private final Color electricColor = new Color(MathUtils.random(0.8F, 1.0F), MathUtils.random(0.8F, 1.0F), 0.5F, 0.0F);
    private final Color shadowColor = new Color(MathUtils.random(0.8F, 1.0F), 0.2F, MathUtils.random(0.8F, 1.0F), 0.0F);
    private final Color defaultColor = Color.WHITE.cpy();

    public ElementParticleEffect(AbstractVivianDamageModifier mod, float x, float y, float oX, float oY, float scale, float angle) {
